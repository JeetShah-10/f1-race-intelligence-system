...
export function SignupPage() {
    ...
    return (
        <div className="h-screen w-screen overflow-hidden bg-[#030405] relative flex">
            ...
            {/* Ambient Glow */}
            <motion.div
                className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-orange-500/20 rounded-full blur-[200px] pointer-events-none"
                    ...
                    >
                        <Link to="/" className="inline-block mb-6">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <div className="w-5 h-1 bg-orange-500/50 rounded-full" />
                            </div>
                        ...
                        <p className="text-lg text-white/50 max-w-md leading-relaxed mb-8">
                            Get access to AI-powered predictions and strategy tools used by motorsport enthusiasts worldwide.
                        </p>

                        <div className="space-y-3">
                            {[
                                { text: 'Predictive race simulations' },
                                { text: 'Driver performance analysis' },
                    ...
                    >
                        <div className="w-full max-w-md">
                            <div className="relative p-8 bg-black/40 backdrop-blur-xl border border-white/[0.08] rounded-2xl">
                                ...
                                <p className="text-white/40 mb-5 text-sm">Start your racing intelligence journey</p>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-2.5 bg-white/[0.03] border rounded-xl text-white placeholder-white/20 focus:outline-none transition-all text-sm ${focusedField === 'name'
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-2.5 bg-white/[0.03] border rounded-xl text-white placeholder-white/20 focus:outline-none transition-all text-sm ${focusedField === 'email'
                                                ? 'border-orange-500/50 shadow-[0_0_20px_rgba(249,115,22,0.15)]'
                                                : 'border-white/[0.08] hover:border-white/15'
                                                }`}
                                            required
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onBlur={() => setFocusedField(null)}
                                                placeholder="••••••••"
                                                className={`w-full px-4 py-2.5 pr-11 bg-white/[0.03] border rounded-xl text-white placeholder-white/20 focus:outline-none transition-all text-sm ${focusedField === 'password'
                                                    ? 'border-orange-500/50 shadow-[0_0_20px_rgba(249,115,22,0.15)]'
                                                    : 'border-white/[0.08] hover:border-white/15'
                                                    }`}
                                                required
                                            ...
                                            >
                                                <div className="flex-1 flex gap-1">
                                                    {[1, 2, 3].map((level) => (
                                                        <div
                                                            key={level}
                                                            className={`h-0.5 flex-1 rounded-full transition-colors ${level <= passwordStrength.level ? passwordStrength.color : 'bg-white/10'
                                                                }`}
                                                        />
                                                    ))}
                                                </div>
                                                <span className="text-xs text-white/40">{passwordStrength.text}</span>
                                            </motion.div>
                                        )}
                                    </div>
                                    ...
                                    <label className="flex items-start gap-2 cursor-pointer group">
                                        <div className={`w-4 h-4 mt-0.5 rounded border transition-all flex items-center justify-center flex-shrink-0 ${agreeTerms ? 'bg-orange-500 border-orange-500' : 'border-white/20 group-hover:border-white/40'
                                            }`}>
                                            {agreeTerms && (
                                        ...
                                        <span className="text-xs text-white/40 group-hover:text-white/60 leading-relaxed">
                                            I agree to the <a href="#" className="text-orange-500 hover:underline">Terms</a> and <a href="#" className="text-orange-500 hover:underline">Privacy Policy</a>
                                        </span>
                                    </label>
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.99 }}
                                        className="w-full py-3 mt-1 bg-orange-500 text-white font-semibold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30"
                                    >
                                        {isLoading ? (
                                            <>
                                ...
                                <p className="mt-4 text-center text-white/40 text-sm">
                                    ...
                                    <Link to="/login" className="text-orange-500 hover:text-orange-400 font-semibold transition-colors">Sign in</Link>
                                </p>
                            </div>
                        </div>
                    </motion.div>
